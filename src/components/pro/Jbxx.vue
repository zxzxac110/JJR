    ...
    <div style="position:relative;z-index:0">
      <main>
        ...
        <div class="l_ipt">
          ...
          <input type="text"
                 class="l_right"
                 placeholder="请输入简历上的姓名"
                 v-model="ajaxdata.nickname">
        </div>
        <div class="l_ipt">
        ...
        <div class="l_ipt">
          ...
          <input type="text"
                 class="l_right"
                 placeholder="请选择"
                 v-model="ajaxdata.xprovince">
          <i class="iconfont l_dayuh">&#xe65f;</i>
        </div>
        <div class="l_textare">
          <h3 style="font-weight:normal;height:30px;margin:0;"
              class="l_text">自我介绍</h3>
          <textarea style="margin:0"
                    name
                    id
                    cols="30"
                    rows="10"
                    v-model="ajaxdata.introduce"></textarea>
