<template>
  ...
  <div class="text-center login">
    ...
    <div class="loginD-none">
      <div><span :class="spanswitch?spanDefault:null"
              @click="per('ym')">账号登录</span></div>
      <div><span :class="!spanswitch?spanDefault:null"
              @click="per('sms')">短信验证码登录</span>
      </div>
    </div>
    <mt-tab-container v-model="active">
      ...
      <mt-tab-container-item id="sms">
        <loginsms :yzmspan="yzmspan"
                  :Yzm="Yzm"
                  :smsColor="smsColor"
                  @yzmfun="getUrl"></loginsms>
      </mt-tab-container-item>
    </mt-tab-container>
    <div class="text-right">忘记密码</div>
    <mt-button @click="login"
               class="tlogin">登录</mt-button>
    <mt-button @click="reg"
               class="treg">注册</mt-button>
